            ...
            <>
                ...
                <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
                    ...
                    >
                        ...
                        the <a className="text-blueGray-700 hover:text-blueGray-500" href="https://www.reddit.com/r/harrypotter/" target="_blank">r/harrypotter</a> subreddit.<br/>
                        The purpose of the analyisis has been to compare the two networks by their communities and the sentiment in the communication of these communities.<br/>
                        Scroll down the page to see what we found or take a look at the Jupyter Notebooks to get 
